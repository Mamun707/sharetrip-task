...
function ProductsCard() {
    return (
        <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-5'>
            <div
                className='w-full max-w-sm bg-white border border-transparent rounded-lg shadow-sm hover:border-gray-200 hover:shadow-lg dark:bg-gray-800 dark:border-transparent dark:hover:border-gray-700'>
                <a href='#'>
                    <img className='rounded-lg w-full' src='/images/products/demo1.jpg' alt='img'/>
                </a>
                <div className='p-2'>
                    ...
                    <p className='line-clamp-2 max-w-[50ch] text-[#1A2B3D] text-[14px] sm:text-[16px] font-semibold'
