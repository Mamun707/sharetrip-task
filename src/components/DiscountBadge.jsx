        ...
        <div className='relative'>
            ...
            <div className='h-10 w-8 absolute left-[210px] top-4'>
                <div className='absolute  left-0 z-40'>
                    <div className='w-[28px] h-[35px] bg-gray-700 bg-transparent rounded-tr-lg overflow-hidden relative'>
                        <div className='border-b-[35px] border-b-transparent border-l-[35px] border-l-[rgba(247,177,102,1)]'></div>
                    </div>
                </div>
                <div className='absolute bottom-0 left-0 z-30'>
                    <div className='w-[28px] h-[35px] bg-gray-700 bg-transparent rounded-br-lg overflow-hidden relative'>
